...
* [HEALTHCHECK](https://docs.docker.com/engine/reference/builder/#healthcheck) - Ajoute un HEALTHCHECK qui envoie une requête ```HTTP GET``` au site et renvoie s'il a obtenu un code de réponse 200.
