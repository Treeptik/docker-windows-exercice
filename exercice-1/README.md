...
* FROM spécifie l'image à utiliser comme point de départ pour cette image. Microsoft / aspnet est une image détenue par Microsoft, qui vient avec IIS et ASP.NET installé sur Windows Server Core
