...
Jetez un oeil au Dockerfile pour cette application, qui crée un simple site Web ASP.NET en cours d'exécution et qui affiche le nom d'hôte du serveur. Il n'y a que deux instructions:
